...
| 34 | Custom History Store | Plug in any storage back-end via IHistoryStore (SQL, InfluxDB, files, ...) |
| 35 | Custom Event History Store | Plug in any storage back-end via IEventHistoryStore |
